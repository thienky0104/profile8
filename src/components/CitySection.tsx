...
const cityModels: Record<string, Model[]> = {
  ...
  hn: [
    ...
    { name: 'Mỹ Duyên', age: 26, district: 'Bắc Từ Liêm', price: 10, height: 168, weight: 55, views: 98.7, tags: ['Vui vẻ', 'Nhiệt tình'], vip: false, image: 'https://pbs.twimg.com/media/HCYU9Qia4AE7t3r?format=jpg&name=4096x4096' },
  ],
  dn: [
    ...
    { name: 'Bảo Ngọc', age: 19, district: 'Ngũ Hành Sơn', price: 9, height: 166, weight: 46, views: 138.6, tags: ['Nhiệt tình'], vip: false, image: 'https://pbs.twimg.com/media/HCYMSd3acAAZGA6?format=jpg&name=large' },
    { name: 'Yến Nhi', age: 23, district: 'Liên Chiểu', price: 12, height: 160, weight: 51, views: 131.4, tags: ['Thân thiện', 'Dễ thương'], vip: true, image: 'https://pbs.twimg.com/media/HCYMcR7bcAAL7R3?format=jpg&name=4096x4096' },
    { name: 'Khánh Phương', age: 21, district: 'Cẩm Lệ', price: 10, height: 163, weight: 49, views: 124.9, tags: ['Qua đêm'], vip: false, image: 'https://pbs.twimg.com/media/HCYM5ouaYAAbNJp?format=jpg&name=4096x4096' },
    { name: 'Hà Phương', age: 27, district: 'Hòa Vang', price: 16, height: 167, weight: 53, views: 118.7, tags: ['Sang trọng'], vip: false, image: 'https://pbs.twimg.com/media/HCYUeTYawAA7GrR?format=jpg&name=4096x4096' },
  ...
  nt: [
    ...
    { name: 'Hương Giang', age: 19, district: 'Phương Sài', price: 10, height: 160, weight: 48, views: 159.3, tags: ['Vui vẻ', 'Năng động'], vip: true, image: 'https://pbs.twimg.com/media/HCYOXwnaoAAT397?format=jpg&name=4096x4096' },
    { name: 'Thảo Nguyên', age: 21, district: 'Phương Sơn', price: 12, height: 163, weight: 50, views: 148.7, tags: ['Nhẹ nhàng'], vip: true, image: 'https://pbs.twimg.com/media/HCYOmMYbkAABZzR?format=jpg&name=large' },
    { name: 'Minh Châu', age: 26, district: 'Vĩnh Hải', price: 16, height: 158, weight: 53, views: 141.2, tags: ['Sang trọng', 'Tinh tế'], vip: true, image: 'https://pbs.twimg.com/media/HCYOuMEawAATMAK?format=jpg&name=4096x4096' },
    { name: 'Lan Phương', age: 20, district: 'Vĩnh Nguyên', price: 9, height: 167, weight: 47, views: 135.6, tags: ['Nhiệt tình', 'Dễ thương'], vip: false, image: 'https://pbs.twimg.com/media/HCYUr2BbQAAWsOr?format=jpg&name=4096x4096' },
    { name: 'Nhã Di', age: 24, district: 'Vĩnh Phước', price: 13, height: 161, weight: 52, views: 128.4, tags: ['Qua đêm'], vip: false, image: 'https://pbs.twimg.com/media/HCYPtSNagAAc8E7?format=jpg&name=4096x4096' },
    ...
    { name: 'Kim Anh', age: 21, district: 'Vĩnh Trường', price: 10, height: 159, weight: 48, views: 99.7, tags: ['Hài hước', 'Vui vẻ'], vip: true, image: 'https://pbs.twimg.com/media/HCYQ27tbsAAwa7o?format=jpg&name=4096x4096' },
    { name: 'Thùy Dương', age: 23, district: 'Phước Tiến', price: 14, height: 166, weight: 53, views: 94.1, tags: ['Lắng nghe', 'Chia sẻ'], vip: false, image: 'https://pbs.twimg.com/media/HCYRE64bIAAklz5?format=jpg&name=4096x4096' },
  ],
};
