...
const cityModels: Record<string, Model[]> = {
  ...
  hn: [
    ...
    { name: 'Diệu Nhi', age: 23, district: 'Ba Đình', price: 14, height: 160, weight: 51, views: 164.5, tags: ['Nhiệt tình', 'Vui vẻ'], vip: true, image: 'https://pbs.twimg.com/media/HCXQqwiaQAAvKCt?format=jpg&name=4096x4096' },
    ...
    { name: 'Bích Phương', age: 22, district: 'Hai Bà Trưng', price: 10, height: 166, weight: 53, views: 136.9, tags: ['Thân thiện', 'Hài hước'], vip: false, image: 'https://pbs.twimg.com/media/HCK99-YaoAAn-jQ?format=jpg&name=large' },
    { name: 'Quỳnh Anh', age: 20, district: 'Tây Hồ', price: 9, height: 162, weight: 48, views: 129.4, tags: ['Qua đêm'], vip: true, image: 'https://pbs.twimg.com/media/HCK99-YaoAAn-jQ?format=jpg&name=large' },
    { name: 'Trà My', age: 24, district: 'Thanh Xuân', price: 13, height: 159, weight: 50, views: 122.8, tags: ['Nhẹ nhàng'], vip: false, image: 'https://pbs.twimg.com/media/HCK99-YaoAAn-jQ?format=jpg&name=large' },
    { name: 'Hải Yến', age: 27, district: 'Hà Đông', price: 11, height: 167, weight: 54, views: 118.3, tags: ['Tình cảm', 'Lãng mạn'], vip: false, image: 'https://pbs.twimg.com/media/HCK99-YaoAAn-jQ?format=jpg&name=large' },
    { name: 'Vân Anh', age: 21, district: 'Long Biên', price: 8, height: 161, weight: 46, views: 112.6, tags: ['Năng động'], vip: false, image: 'https://pbs.twimg.com/media/HCK99-YaoAAn-jQ?format=jpg&name=large' },
    { name: 'Phương Linh', age: 23, district: 'Nam Từ Liêm', price: 12, height: 164, weight: 51, views: 108.9, tags: ['Bí ẩn'], vip: false, image: 'https://pbs.twimg.com/media/HCK99-YaoAAn-jQ?format=jpg&name=large' },
    { name: 'Thúy Nga', age: 19, district: 'Hoàng Mai', price: 14, height: 156, weight: 47, views: 104.2, tags: ['Chiều chuộng', 'Dễ thương'], vip: false, image: 'https://pbs.twimg.com/media/HCK99-YaoAAn-jQ?format=jpg&name=large' },
