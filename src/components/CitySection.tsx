...
const cityModels: Record<string, Model[]> = {
  ...
  dn: [
    ...
    { name: 'Hà Phương', age: 27, district: 'Hòa Vang', price: 16, height: 167, weight: 53, views: 118.7, tags: ['Sang trọng'], vip: false, image: 'https://pbs.twimg.com/media/HCYNBWHbsAAh02q?format=jpg&name=4096x4096' },
  ...
  nt: [
    ...
    { name: 'Lan Phương', age: 20, district: 'Vĩnh Nguyên', price: 9, height: 167, weight: 47, views: 135.6, tags: ['Nhiệt tình', 'Dễ thương'], vip: false, image: 'https://pbs.twimg.com/media/HCYPIO9b0AA2FcU?format=jpg&name=4096x4096' },
